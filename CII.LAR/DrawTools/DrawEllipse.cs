...
namespace CII.LAR.DrawTools
{
    ...
    public class DrawEllipse : DrawObject
    {
        ...
        public DrawEllipse(RichPictureBox richPictureBox, int x1, int y1, int x2, int y2, double c) : this()
        {
            ...
            drawAreaSize = richPictureBox.Size;
        ...
        {
            var length = richPictureBox.PixelToMicroscope((2 * Math.PI * (ellipseForDraw.Rectangle.Height / 2) + 
                4 * (ellipseForDraw.Rectangle.Width / 2 - ellipseForDraw.Rectangle.Height / 2)));
        ...
        {
            var area = Math.PI * richPictureBox.PixelToMicroscope(ellipseForDraw.Rectangle.Width / 2) *
                richPictureBox.PixelToMicroscope(ellipseForDraw.Rectangle.Height / 2);
