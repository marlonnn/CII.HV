    ...
    public class Rulers
    {
        ...
        public void DrawHorizontalRuler(Graphics g, Pen pen)
        {
            ...
            for ( ; x1Coord < richPictureBox.Width; x1Coord += RulerStep)
            {
                ...
                if (x1 != 0)
                {
                    DrawScaledNumber(g, x1 / (int)Program.SysConfig.Lense.Factor, x1Coord, richPictureBox.Height / 2 - 20, 1, true);
                }
                x1 += this.rulerStep;
                ...
                if (x2 != 0)
                {
                    DrawScaledNumber(g, x2 / (int)Program.SysConfig.Lense.Factor, x2Coord, richPictureBox.Height / 2 - 20, 1, true);
                }
                x2Coord -= RulerStep;
                x2 -= this.rulerStep;
            }
        ...
        public void DrawVerticalRuler(Graphics g, Pen pen)
        {
            ...
            for ( ; y1Coord < richPictureBox.Height; y1Coord += RulerStep)
            {
                ...
                if (y1 != 0)
                {
                    DrawScaledNumber(g, y1 / (int)Program.SysConfig.Lense.Factor, richPictureBox.Width / 2 - 20, y1Coord - 2, 1, true);
                }
                y1 += this.rulerStep;
                ...
                if (y2 != 0)
                {
                    DrawScaledNumber(g, y2 / (int)Program.SysConfig.Lense.Factor, richPictureBox.Width / 2 - 20, y2Coord - 2, 1, true);
                }
                y2Coord -= RulerStep;
                y2 -= this.rulerStep;
            }
