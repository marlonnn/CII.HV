...
namespace CII.LAR.MaterialSkin
{
    class MsgBox : Form
    {
        ...
        private MsgBox()
        {
            ...
            this.BackColor = MaterialSkinManager.Instance.BaseCtrlTitleColor;
            ...
            _lblTitle.Font = MaterialSkinManager.Instance.PINGFANG_MEDIUM_12;
            _lblTitle.Dock = DockStyle.Top;
            _lblTitle.Height = 50;

            _lblMessage = new Label();
            _lblMessage.ForeColor = Color.White;
            _lblMessage.Font = MaterialSkinManager.Instance.PINGFANG_MEDIUM_12;
            ...
            _plFooter.BackColor = Color.FromArgb(0x1F, 0x24, 0x2A);
            _plFooter.Height = 80;
        ...
        private static void InitButtons(Buttons buttons)
        {
            ...
            foreach (Button btn in _msgBox._buttonCollection)
            {
                ...
                btn.Font = MaterialSkinManager.Instance.PINGFANG_MEDIUM_9;
        ...
        private void InitAbortRetryIgnoreButtons()
        {
            ...
            btnAbort.Tag = "Abort";
            btnAbort.Text = Properties.Resources.StrAbort;
            btnAbort.Click += ButtonClick;

            Button btnRetry = new Button();
            btnRetry.Tag = "Retry";
            btnRetry.Text = Properties.Resources.StrRetry;
            btnRetry.Click += ButtonClick;

            Button btnIgnore = new Button();
            btnIgnore.Tag = "Ignore";
            btnIgnore.Text = Properties.Resources.StrIgnore;
        ...
        private void InitOKButton()
        {
            ...
            btnOK.Tag = "OK";
            btnOK.Text = Properties.Resources.StrOK;
        ...
        private void InitOKCancelButtons()
        {
            ...
            btnCancel.Text = Properties.Resources.StrCancel;
        ...
        private void InitRetryCancelButtons()
        {
            Button btnRetry = new Button();
            btnRetry.Tag = "OK";
            btnRetry.Text = Properties.Resources.StrOK;
            btnRetry.Click += ButtonClick;
        ...
        private void InitYesNoButtons()
        {
            ...
            btnYes.Tag = "Yes";
            btnYes.Text = Properties.Resources.StrYes;
        ...
        private void InitYesNoCancelButtons()
        {
            Button btnYes = new Button();
            btnYes.Tag = "Abort";
            btnYes.Text = Properties.Resources.StrAbort;
            btnYes.Click += ButtonClick;

            Button btnNo = new Button();
            btnNo.Tag = "Retry";
            btnNo.Text = Properties.Resources.StrRetry;
            btnNo.Click += ButtonClick;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Pen pen = new Pen(MaterialSkinManager.Instance.GroupBoxBorderColor);
