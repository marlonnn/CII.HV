...
namespace CII.LAR.SysClass.Shortcuts
{
    ...
    /// </summary>
    [Serializable]
    public class HotKeyManager : IMessageFilter, IDisposable // , IEnumerable, IEnumerable<GlobalHotKey>, IEnumerable<LocalHotKey>, IEnumerable<ChordHotKey>
    {
        ...
        public void SetFormHandle(IWin32Window form)
        {
